...
/**
 * Typ wyliczeniowy PersonJob reprezentuje przykładowe stanowiska, które może
 * zajmować osoba. Klasa została zaimplementowana tak, by mogła być rozszerzana
 * o dodatkowe stanowiska. W tym celu wystarczy do zdefiniowanej listy dodać
 * kolejne wywołanie konstruktora.
 */
enum PersonJob {
	UNKNOWN("-------"), GUEST("Gość"), STUDENT("Student"), TEACHER("Nauczyciel"), MANAGER("Kierownik"),
	DIRECTOR("Dyrektor");
 ...
 * atrybutów: imię, nazwisko, rok urodzenia, stanowisko. W klasie przyjęto
 * ograniczenia: - pola firstName oraz lastName muszą zawierać niepusty ciąg
 * znaków - pole birthYear musi zawierać liczbę z przedziału [1900-2030] lub 0
 * (0 oznacza niezdefiniowany rok urodzenia). - pole job musi zawierać wyłącznie
 * jedną z pozycji zdefiniowanych w typie wyliczeniowym enum PersonJob.
 *
